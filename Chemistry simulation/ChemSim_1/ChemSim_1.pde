...
PartType Hydro=   new PartType(/*Type*/0, /*Color*/ new int[]{255,10,30} ,/*radius*/8,/*mass*/10,/*electrons*/1,/*max electrons*/2,/*e neutral*/1,/*electron energy*/0,/*mom inert*/15,/*Bond angles*/new float[]{0},/*Bond ang K*/new float[]{0.2},/*Num HBonds*/1);
PartType Oxy=     new PartType(/*Type*/1,/*Color*/ new int[]{10,30,255},/*radius*/15,/*mass*/20,/*electrons*/2,/*max electrons*/2,/*e neutral*/2,/*electron energy*/0,/*mom inert*/15,/*Bond angles*/new float[]{3.14,1.8},/*Bond ang K*/new float[]{0.2,0.2},/*Num HBonds*/2);
PartType Sodi=    new PartType(/*Type*/2,/*Color*/ new int[]{10,30,255},/*radius*/25,/*mass*/35,/*electrons*/1,/*max electrons*/1,/*e neutral*/1,/*electron energy*/-20,/*mom inert*/40,/*Bond angle*/new float[]{0},/*Bond K*/new float[]{2},0);
PartType Chlori=  new PartType(/*Type*/3,/*Color*/ new int[]{10,30,255},/*radius*/25,/*mass*/35,/*electrons*/0,/*max electrons*/1,/*e neutral*/0,/*electron energy*/20,/*mom inert*/30,/*Bond angle*/new float[]{0},/*Bond K*/new float[]{2},0);
